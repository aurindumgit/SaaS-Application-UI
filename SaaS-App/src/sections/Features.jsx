                    ...
                    {features.map(({id, icon, caption, title, text,button}) => (
                        <div key={id} className='relative z-2 md:px-10 px-5 md:pb-10 pb-5 flex-50 max-md:g7 max-md:border-2 max-md:border-s3 max-md:rounded-3xl max-md:flex-320'>
                            <div className='w-full flex justify-start items-start'>
                                <div className='-l-3 mb-12 flex items-center justify-center flex-col'>
                            ...
                            <h2 className='max-w-500 mb-7 h3 text-p4 max-md:mb-6 max-md:h5'> {title}</h2>
                    ...
                    <ul className='relative flex justify-around flex-grow px-[5%] border-2 border-s3 rounded-7xl max-md:hidden'>
                        ...
                        {details.map(({id, icon, title})=>(
                            <li key={id} className='relative pt-16 px-4 pb-14'>
                                ...
                                <div className='flex items-center justify-center mx-auto mb3 border-2 border-s2 rounded-full hover:border-s4 transition-all duration-500 shadow-500 size-20'>
